...
private extension LocalizedStringResource {
    ...
    static let deleteAppStartDescription: Self =
        "This will delete the date of the first app start. This information is only relevant for achievements"
    ...
    static let deleteDataDescription: Self =
        "This will delete all logged data like injections, lab results other things that you have logged in the app."
}
