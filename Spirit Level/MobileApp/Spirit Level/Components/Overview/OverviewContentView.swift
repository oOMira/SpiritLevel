...
struct OverviewContentView<Dependencies: OverviewDependencies>: View {
    ...
    var body: some View {
        ...
        .refreshable {
            viewModel.dependencies.injectionRepository.refresh()
            viewModel.dependencies.labResultsRepository.refresh()
            viewModel.dependencies.treatmentPlanRepository.refresh()
        }
        // MARK: Navigation
